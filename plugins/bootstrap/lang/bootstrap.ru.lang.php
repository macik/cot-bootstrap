...
$L['cfg_path_to_cdn'] =array('Путь к файлам на CDN','по умолчанию (если не заданно) используется: '."//netdna.bootstrapcdn.com/bootstrap/{$cfg['bootstrap']}/");
...
$L['bsw_not_found'] = 'Файл <b>{$file}</b> не найден, проверьте пуказанный в настройках путь.';
